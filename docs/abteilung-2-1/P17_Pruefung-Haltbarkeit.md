# Prozess 17: Prüfung Haltbarkeit
...
| | |
| --- | --- |
| **Prozess-Nr.** | 17 (im Original fälschlich als Nr. 7 geführt → korrigiert) |
| **Verantwortlich** | → [Übersicht](00_Uebersicht-Prozesse-Verantwortlichkeiten.md) |
| **Turnus** | wöchentlich (fester Wochentag wird zu Schuljahresbeginn festgelegt) |
| **Schnittstellen** | Team Inventur · Team Einkaufsliste · Lehrkraft · Schichtgruppe |

## Ziel / Kurzbeschreibung

Es muss regelmäßig geprüft werden, ob bzw. wie lange die angebotenen Artikel noch haltbar sind.
